    ...
    <>
      <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
        ...
        >
          ...
          >
            elite Auto Engineering designs and manufactures the world's most advanced self-healing films. From race tracks to city streets, we define the standard of invisible armor.
          </motion.p>
