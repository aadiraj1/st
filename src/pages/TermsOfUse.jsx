  ...
  const sections = [
    {
      ...
      content: "By accessing, browsing, or using the Starkx.Pro website and services, you acknowledge that you have read, understood, and agree to be bound by these Terms of Use and all applicable laws and regulations. If you do not agree to these terms, you are not authorized to use our platform or purchase our products. These terms constitute a legally binding agreement between you and Starkx.Pro Manufacturing Corp."
    },
    {
      title: "2. Intellectual Property Rights",
      icon: <BookOpen className="text-accent" size={24} />,
      content: "All content on this site, including but not limited to text, graphics, logos, icons, images, audio clips, digital downloads, data compilations, and software (including our proprietary DAP Software), is the exclusive property of Starkx.Pro Manufacturing Corp. and is protected by international copyright, trademark, and patent laws. Unauthorized reproduction, modification, or distribution of these materials is strictly prohibited."
    },
    {
      ...
      <section className="px-4 md:px-8 max-w-5xl mx-auto relative z-10">
        ...
        >
          ...
          <p className="text-gray-500 max-w-2xl mx-auto text-lg font-medium leading-relaxed">
            Last Updated: April 29, 2026. These terms govern your access to and use of Starkx.Pro's global digital ecosystem and professional protection services.
          </p>
        </motion.div>
