    ...
    sections: [
      {
        ...
        p: "This agreement governs the use of Starkx.Pro's global digital platforms, including the primary website, dealer portal, and Design Access Program (DAP)."
      },
      {
    ...
    sections: [
      {
        ...
        p: "Starkx.Pro technologies are protected under global patent filings covering polymer and adhesive systems."
      },
      {
    ...
    <div className="pt-28 min-h-screen bg-black text-white pb-32">
      ...
      <section className="mt-32 px-4 md:px-8 max-w-5xl mx-auto text-center opacity-30">
        <p className="text-[9px] font-black text-gray-500 uppercase tracking-[0.3em] leading-loose">
          Starkx.Pro LEGAL SYSTEM IS MONITORED AND ENCRYPTED. ALL ACCESS IS LOGGED FOR COMPLIANCE AUDITING PURPOSES. © 2026 Starkx.Pro MANUFACTURING CORP.
        </p>
      </section>
