...
const leaders = [
  {
    ...
    bio: "With a PhD in Polymer Physics from Stanford, Dr. Vance spent a decade leading material science teams in the aerospace industry before founding Elite Auto. His obsession with 'optical clarity' led to the development of the Titan top-coat series. He believes that protection should never be a compromise for beauty.",
      ...
      <section className="mt-32 px-4 md:px-8 max-w-5xl mx-auto">
        <div className="bg-gradient-to-br from-secondary/40 to-black border border-white/10 rounded-[40px] p-12 text-center">
          ...
          <p className="text-gray-500 max-w-xl mx-auto text-sm font-medium leading-relaxed">
            Elite Auto adheres to the highest standards of transparency and ethics. Our global advisory board includes veterans from the automotive and chemical industries.
          </p>
        </div>
      </section>
